...
function Customer() {
    ...
    const columns = [
        ...
        { field: 'orders', headerName: 'ORDERS', width: 150, sortable: false },
        { field: 'money_spent', headerName: 'MONEY SPENT', width: 150, sortable: false },
        { field: 'last_order', headerName: 'LAST ORDER', width: 150, sortable: false },
        {
    ...
    const rows = [
        { id: uuidv4(), name: 'Pranay', user_name: 'Pranay123', email: 'Example@gmail.com', location: 'LOCATION', orders: '3', money_spent: '$3428', last_order: '22 Oct 2023' },
        { id: uuidv4(), name: 'Pranay', user_name: 'Pranay123', email: 'Example@gmail.com', location: 'LOCATION', orders: '3', money_spent: '$3428', last_order: '22 Oct 2023' },
        { id: uuidv4(), name: 'Pranay', user_name: 'Pranay123', email: 'Example@gmail.com', location: 'LOCATION', orders: '3', money_spent: '$3428', last_order: '22 Oct 2023' },
    ];
