...
function addProduct() {
    ...
    const handleFormSubmit = async (values, setSubmitting) => {
        ...
        try {
            let response = await fetch("https://dev.cleantech-mart.com/wp-json/wcfmmp/v1/products/", {
                method: "POST",
                body: bodyContent,
                headers: headersList
            });
            ...
            toast.success("Your Product is Under Review")
            setSubmitting(false);
            router.push('/pages/home/vendor/products');
        } catch (error) {
